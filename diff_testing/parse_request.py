        ...
        for line in f_in:
            ...
            if match:
                ...
                try:
                    ...
                    if json_data["flightDataSource"] != 2:
                        continue
